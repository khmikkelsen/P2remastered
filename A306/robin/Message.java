...
public class Message {
    ...
    public String getSignatureInputString ()
    {
        return recipientPublicKey.getBase64String()+senderPublicKey.getBase64String()+message;
    }
    ...
    public int getByteSize ()
    {
        ...
        byte[] bytes2 = senderPublicKey.getBase64String().getBytes();
        byte[] bytes3 = recipientPublicKey.getBase64String().getBytes();
        byte[] bytes4 = signature.getBytes();

        return bytes.length + bytes2.length + bytes3.length + bytes4.length;
    }
